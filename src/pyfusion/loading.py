...
def load_fsl(dir: str, slice: int, image_file: str = "FA") -> FSL:
    """
    ...
    Args:
        ...
        image_file (str): Name of the image file to load. Default is "FA".
    ...
    FA = nib.load(os.path.join(dir, f"{image_file}.nii.gz")).get_fdata()
